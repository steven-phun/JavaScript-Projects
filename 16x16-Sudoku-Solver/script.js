...
const generateBoards = () => {
  ...
  board.push([[7, empty, 8, empty, 9, empty, empty, 11, 15, empty, 14, 12, empty, 10, empty, 3],
    [empty, empty, 14, empty, empty, 15, 4, empty, empty, 6, empty, 9, empty, empty, 12, empty],
    [1, empty, empty, 9, empty, 5, empty, 3, empty, empty, 8, empty, empty, 15, empty, 13],
    [empty, 5, empty, 2, empty, empty, 13, empty, empty, empty, 10, empty, 8, empty, 9, empty],
    [empty, empty, 12, empty, empty, 8, empty, empty, 0, empty, empty, 1, empty, empty, 13, 6],
    ...
    [15, empty, 13, empty, empty, empty, 8, empty, 5, empty, empty, 10, empty, 0, empty, 2],
    [0, empty, empty, empty, 2, empty, empty, 4, 13, empty, empty, empty, 5, empty, 15, empty],
